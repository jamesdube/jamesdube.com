<template>
    <div class="//text-white //py-40 font-bar pb-8 h-full py-48 px-48 //bg-gray-900">
        <div>
            <div class="">
                <span class="text-lg text-brand-accent font-foo">01.</span>
                <span class="text-3xl px-4 font-black text-white">About Me</span>
            ...
            <div class="flex py-12">
                ...
                <div class="pl-16">
                    <img class="max-w-sm rounded-full" src="https://en.gravatar.com/userimage/88811832/51311e839df66a9aac3654bff9fa45dd.jpeg">
                </div>
            </div>
